...
from LinSysSolver.system_eq import NumberedEquation, SystemEq
...
def test_emptysys_init() -> None:
    ...
    with pytest.raises(TypeError):
        SystemEq.from_csv("tests/csv_files/empty.csv")
    with pytest.raises(TypeError):
        SystemEq()
...
def test_invalid_init() -> None:
    ...
    with pytest.raises(ValueError):
        SystemEq.from_csv("tests/csv_files/unpaired1.csv")
    with pytest.raises(ValueError):
        SystemEq.from_csv("tests/csv_files/unpaired2.csv")
    with pytest.raises(ValueError):
        SystemEq.from_csv("tests/csv_files/unpaired3.csv")
...
def test_init() -> None:
    ...
    """
    system_from_csv = SystemEq.from_csv("tests/csv_files/system.csv")
...
def test_str() -> None:
    ...
    """
    system_for_display = SystemEq.from_csv("tests/csv_files/system.csv")
...
def test_del_eq_if_zero() -> None:
    ...
    """
    system_with_zeros = SystemEq.from_csv("tests/csv_files/row_all_zero.csv")
...
def test_unused_unknowns() -> None:
    ...
    """
    system_with_unused = SystemEq.from_csv("tests/csv_files/unused_unknowns.csv")
...
def test_minimize() -> None:
    ...
    """
    standard_system = SystemEq.from_csv("tests/csv_files/system.csv")
    redundant_system = SystemEq.from_csv("tests/csv_files/system_to_minimize1.csv")
    mixed_redundancy_system = SystemEq.from_csv("tests/csv_files/system_to_minimize2.csv")
...
def test_sort_by_abs() -> None:
    ...
    """
    system_to_sort = SystemEq.from_csv("tests/csv_files/system_to_sort.csv")
...
def test_zeroes_pivot_column() -> None:
    ...
    """
    system_for_elimination = SystemEq.from_csv("tests/csv_files/system_to_zeroes.csv")
...
def test_solve_unique(capsys: pytest.CaptureFixture[str]) -> None:
    ...
    """
    system_unique_5x5 = SystemEq.from_csv("tests/csv_files/test1.csv")
...
"""
    system_unique_6x6 = SystemEq.from_csv("tests/csv_files/test2.csv")
...
"""
    single_equation_system = SystemEq.from_csv("tests/csv_files/single_eq_system.csv")
...
def test_solve_no_solution(capsys: pytest.CaptureFixture[str]) -> None:
    ...
    """
    inconsistent_system_1 = SystemEq.from_csv("tests/csv_files/test4.csv")
...
"""
    inconsistent_system_2 = SystemEq.from_csv("tests/csv_files/test5.csv")
...
"""
    simple_inconsistent_system = SystemEq.from_csv("tests/csv_files/es11.csv")
...
def test_solve_infinitely_many_solutions(capsys: pytest.CaptureFixture[str]) -> None:
    ...
    """
    underdetermined_system = SystemEq.from_csv("tests/csv_files/test3.csv")
...
"""
    single_equation_underdetermined = SystemEq.from_csv("tests/csv_files/single_eq_system2.csv")
...
def test_all_zeroes(capsys: pytest.CaptureFixture[str]) -> None:
    ...
    """
    all_zero_system = SystemEq.from_csv("tests/csv_files/all_zero.csv")
...
E4: 0 x1 + 0 x2 + 0 x3 + 1 x4 - 1/25 x5 - 8/5 = 0
"""
    inconsistent_system = SystemEq.from_csv("tests/csv_files/test4.csv")
...
E2: 0 x1 + 0 x2 + 0 x3 + 0 x4 + 0 x5 - 2/5 = 0
"""
    system_unique = SystemEq.from_csv("tests/csv_files/test1.csv")
